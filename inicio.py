...
class PantallaInicio:
    ...
    def setup(self):
        fondo = arcade.Sprite("imagenes/fondo_inicio.png")
        ...
        boton_jugar = Boton(
            "imagenes/boton_jugar.png",
            "imagenes/boton_jugar_hover.png",
            0.3,
            "jugar"
        )
        boton_jugar.center_x = ANCHO_PANTALLA / 2
        boton_jugar.center_y = ALTO_PANTALLA / 2 - 225
        self.botones_list.append(boton_jugar)
        ...
        try:
            sound = arcade.load_sound("sonidos/musica_fondo.mp3")
